...
func handleGetFeature(conn *models.Conn, req models.Request, m *Manager) {
...
func handleSetFeature(conn *models.Conn, req models.Request, m *Manager) {
	device, err := params.String(req.Params, "device")
	if err != nil {
		models.RespondError(conn, req.ID, err.Error())
		return
...
func handleResetDefaults(conn *models.Conn, req models.Request, m *Manager) {
	device, err := params.String(req.Params, "device")
	if err != nil {
		models.RespondError(conn, req.ID, err.Error())
		return
